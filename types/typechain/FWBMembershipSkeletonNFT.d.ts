...
interface FWBMembershipSkeletonNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class FWBMembershipSkeletonNFT extends BaseContract {
  ...
  interface: FWBMembershipSkeletonNFTInterface;
